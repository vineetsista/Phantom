  ...
  return (
    <section className="mx-auto max-w-2xl px-6 pb-32 pt-20">
      ...
      <Section title="Generation preferences">
        ...
        <Field label="Default visibility">
          ...
          >
            ...
            <option value="unlisted" disabled={me.plan === "free"}>Unlisted (Pro)</option>
            <option value="private" disabled={me.plan === "free"}>Private (Pro)</option>
          </select>
          {me.plan === "free" && (
            <p className="mt-2 text-xs text-mist">Unlisted + private require Pro.</p>
          )}
        </Field>
        {me.plan !== "free" && (
          <Field label="Custom watermark" hint="Replaces 'Generated by Phantom' (Pro+).">
            <input
      ...
      <Section title="Notifications">
        ...
        />
        <Toggle
          label="Email me on milestones (first 100 views, first Pro upgrade, etc.)"
